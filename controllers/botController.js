    ...
    try {
        ...
        if (!userSessions[chatId]) {
            userSessions[chatId] = [
                ...
                2. KIỂM TRA MÓN BẮT BUỘC (TRA CỨU): Khi khách gọi món, BẮT BUỘC gọi công cụ 'search_menu'. Nếu món khách gọi KHÔNG KHỚP CHÍNH XÁC với tên món trong menu (VD: khách gọi "Cà phê đá" nhưng menu chỉ có "Cà phê đen", "Cà phê sữa"), bạn PHẢI liệt kê các món gần giống để khách chọn lại. TUYỆT ĐỐI KHÔNG ĐƯỢC tự ý chọn bừa một món, và TUYỆT ĐỐI KHÔNG ĐƯỢC hỏi Size hay Số lượng khi khách chưa chọn được TÊN MÓN chính xác.
